...
const Index = () => {
  ...
  /**
   * Handles input changes in the form. Updates the state with the new input
   * value. This function is called whenever an input changes.
    ...
    <div className="bg-[#18191b] min-h-screen w-full">
          ...
          {type === "signin" && (
            <form>
              ...
              <div className="flex py-4 justify-between items-center px-3">
                ...
                <div className="w-[5%] text-center flex pb-1 px-1 text-white">
                  Or
                </div>
                <div className="w-[45%] h-[1px] bg-slate-500 "></div>
              </div>
              ...
              <div className="pb-4">
                <button className="px-3 py-2 flex justify-center items-center rounded-md bg-red-500 w-full outline-none hover:bg-red-600 text-white">
                  <span>
                    <BiLogoGmail />
                  </span>
              ...
              <div className="pb-4">
                <button className="px-3 py-2 flex justify-center rounded-md bg-blue-500 w-full outline-none hover:bg-blue-600 text-white">
                  <span>
                    <FaFacebook />
                  </span>
        ...
        <div className="w-[93%] m-auto py-3">
          <div className="flex justify-between items-center">
            ...
            <div className="flex gap-4">
              <button
                onClick={() => {setType('signin'); setShow(true)}}
                className="py-2 w-[80px] text-center bg-teal-700 transition-all hover:bg-teal-500 rounded-[5px] font-medium"
              >
                SignIn
              </button>
              <button
                onClick={() => {setType('signup'); setShow(true)}}
                className="py-2 w-[80px] text-center bg-purple-700 transition-all hover:bg-purple-500 rounded-[5px] font-medium"
              >
                SignUp
              </button>
            </div>
      ...
      <div className="w-full h-full justify-center items-center p-4">
        <div className="py-[170px] flex justify-center items-center flex-col gap-6">
          <h2 className="text-5xl text-[#c7c5c5]">
          ...
          <button
            onClick={() => {setType('signup'); setShow(true)}}
            className="py-2 w-[200px] text-center bg-purple-700 transition-all hover:bg-purple-500 rounded-[5px] font-medium text-white"
          >
            SignUp for Free
          </button>
        </div>
